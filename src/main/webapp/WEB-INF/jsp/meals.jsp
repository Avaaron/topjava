...
<div class="jumbotron pt-4">
    ...
    <form method="post" class="form-horizontal"  role="form"  id="filter">
        ...
        <button onclick="filter()" class="btn btn-primary" type="submit"><spring:message code="meal.filter"/></button>
        <button onclick="cancel()" class="btn btn-success" type="submit"><spring:message code="common.cancel"/></button>
    <hr>
    ...
    <table class="table table-striped" id="datatable">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr class="str" data-mealExceed="${meal.exceed}" id="${meal.id} ">
                <td>
